                                ...
                                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            ...
                                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="Amount_collection" placeholder="Enter Amount Collection  مبلغ التحصيل" wire:model="Amount_collection">
                                ...
                                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            ...
                                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="Amount_Commission" placeholder="Enter  Amount Commission  مبلغ العمولة" wire:model="Amount_Commission">
                                ...
                                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            ...
                                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="Discount" placeholder="Enter Discount الخصم" wire:model="Discount">
                                ...
                                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            ...
                                            <input type="text" readonly class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="Total" placeholder="Enter Total الاجمالي شامل الضريبة" wire:model="Discount">
...
$(document).ready(function(){
       ...
       $.ajax({
            url:"{{ route('calculate')}}",
            method:'get',
            data:{Amount_Commission:Amount_Commission,Discount:Discount,Rate_VAT:Rate_VAT,'_token':"{{csrf_token()}}"},

            success: function(data) {


                document.getElementById("Value_VAT").value = data.sumq;
                document.getElementById("Total").value = data.sumt;
                console.log(data.sumq);
